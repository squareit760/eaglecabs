...
export default function CarRentalService({ cars }) {
  ...
  {cars.map((car) => (
    ...
    >
      {/* Car Image */}
      <div className="relative bg-white p-3 h-80 w-full flex items-center justify-center group overflow-hidden">
        {/* Shine overlay */}
        <div className="absolute inset-0 bg-gradient-to-r from-transparent via-gray-200/30 to-transparent 
                        -translate-x-full group-hover:translate-x-full 
                        transition-transform duration-[500ms] ease-in-out"></div>
