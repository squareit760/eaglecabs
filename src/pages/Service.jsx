  ...
  const services = [
    {
      ...
      description:
        "Fast, reliable transportation for your daily commute and city travel needs.",
      price: "From $8",
    ...
    },
    {
      ...
      description:
        "Stress-free airport pickup and drop-off with flight tracking and meet & greet service.",
      price: "From $35",
    ...
    },
    {
      ...
      description:
        "Travel in style with our premium vehicles and enhanced comfort features.",
      price: "From $15",
    ...
    },
    {
      ...
      description:
        "Spacious vehicles for family trips, group outings, and team transportation.",
      price: "From $25",
      duration: "Group discounts",
      features: [
        "6-12 seater vehicles",
        "Extra luggage space",
        "Group rates",
        "Event coordination",
      ],
    ...
    },
    {
      ...
      description:
        "Professional transportation solutions tailored for corporate clients and executives.",
      price: "Custom rates",
    ...
    },
    {
      ...
      description:
        "Make your wedding day memorable with our decorated luxury vehicles and professional service.",
      price: "From $150",
    ...
    },
    {
      ...
      description:
        "Rent a cab by the hour for shopping, meetings, city tours, or multiple stops.",
      price: "From $25/hr",
    ...
    },
    {
      ...
      description:
        "Comfortable intercity travel to nearby destinations with experienced drivers.",
      price: "From $0.75/km",
  ...
  const advantages = [
    {
      ...
      title: "Safe & Secure",
      description:
        "All drivers are background-verified with regular vehicle safety inspections.",
    },
    {
      icon: <Zap className="h-12 w-12" />,
      title: "Quick Response",
      description:
        "Average pickup time of 5 minutes with real-time tracking and updates.",
    },
    {
      icon: <Star className="h-12 w-12" />,
      title: "4.9 Star Rating",
      description:
        "Consistently rated as the top cab service by thousands of satisfied customers.",
    },
    {
  ...
  const steps = [
    {
      ...
      description:
        "Select from our range of transportation services based on your needs.",
    },
    {
      number: "02",
      title: "Book Instantly",
      description:
        "Quick booking through our website, app, or phone with instant confirmation.",
    },
    {
      number: "03",
      title: "Track & Ride",
      description:
        "Real-time tracking of your driver with live updates and ETA.",
    },
    {
      number: "04",
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              From quick city rides to luxury corporate transportation, we have
            ...
            {filteredServices.map((service) => (
              ...
              >
                ...
                <div className="p-8">
                  ...
                  <button
                    onClick={handleClick}
                    className="w-full bg-gradient-to-r from-gray-800 to-blue-700 hover:from-gray-700 hover:to-gray-800 text-white font-bold py-4 px-6 rounded-lg transition-all transform group-hover:scale-105"
                  >
                    Book This Service
                  </button>
                </div>
      ...
      <div className="py-16 bg-gradient-to-r from-blue-50 to-indigo-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We're committed to providing the highest quality transportation
              experience with unmatched service standards.
            </p>
          </div>
      ...
      <div className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Booking your ride is simple and straightforward. Follow these easy
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 p-3 gap-8">
            {steps.map((step, index) => (
              <div
                key={index}
                className="text-center relative shadow-2xl rounded-2xl p-9 lg:hover:scale-110 transition-all duration-100 cursor-pointer"
              >
      ...
      <div className="bg-gray-800 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <button
            ...
            className="mt-8 cursor-pointer bg-yellow-400 hover:bg-yellow-500 text-gray-800 font-bold py-3 px-8 rounded-lg text-lg transition-colors"
          >
            Book Now
          </button>
        </div>
